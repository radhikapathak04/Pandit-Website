      ...
      <header className="relative text-center py-20 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-gray-800 text-lg font-medium">
            उज्जैन के अनुभवी वैदिक पंडित द्वारा विवाह पूजा, गृह प्रवेश,
            काल सर्प दोष निवारण, मंगल दोष पूजा, हवन, तंत्र पूजा एवं सभी धार्मिक
            अनुष्ठान। पूरे भारत में ऑनलाइन एवं ऑफलाइन पूजा बुकिंग उपलब्ध।
          </p>
